...
NAME = minishell
INC = -Iincludes -I/usr/local/opt/readline/include # Change readline include path to your correct path -> brew info readline
LIBS = -Llibft -lft -L/usr/local/opt/readline/lib -lreadline # Change readline library path to your correct path -> brew info readline
